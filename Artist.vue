...
export default{
    ...
    methods:{
        delAll(){
              axios.delete('http://ec2-3-16-89-69.us-east-2.compute.amazonaws.com/api/artist',{headers: {"Access-Control-Allow-Origin": "*"}} ).then(res=>{
                  alert("Deleted Succesfull")
                  console.log(res.data)
              })
            },
            delSingle(id){
              axios.delete(`http://ec2-3-16-89-69.us-east-2.compute.amazonaws.com/api/artist/${id}`,{headers: {"Access-Control-Allow-Origin": "*"}}).then(res=>{
                alert("Deleted Succesfull")
                console.log(res)
                this.$forceUpdate();
            })
