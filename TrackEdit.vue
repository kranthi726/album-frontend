...
export default{ 
    ...
    methods:{
            updateTrack(){
                ...
                axios.put(`http://ec2-3-16-89-69.us-east-2.compute.amazonaws.com/api/track/${id}`, this.object).then(res =>{
                    console.log(res)
        ...
        async mounted(){
          const path = this.$route.path
            ...
            await axios.get(`http://ec2-3-16-89-69.us-east-2.compute.amazonaws.com/api/track/${id}`).then(res =>{
