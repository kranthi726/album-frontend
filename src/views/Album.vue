...
export default{
    ...
    data(){
      ...
      methods:{   
            ...
            delAll(){
              axios.delete('http://localhost:8080/api/tutorial').then(res=>{
                  alert("Deleted Succesfull")
                  console.log(res.data)
              })
            },
            delSingle(id){
              axios.delete(`http://localhost:8080/api/tutorial/${id}`).then(res=>{
                alert("Deleted Succesfull")
                console.log(res)
                this.$forceUpdate();
            })
    ...
    mounted(){
      axios.get("http://localhost:8080/api/tutorial")
      .then(res=>{
        console.log(res.data)
